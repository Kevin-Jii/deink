...
type Permission struct {
	...
	ShowLink   int         `json:"showLink"   description:"是否在菜单中展示"`          // 是否在菜单中展示
	ShowParent int         `json:"showParent" description:"是否展示父级菜单"`          // 是否展示父级菜单
	KeepAlive  int         `json:"keepAlive"  description:"页面缓存"`              // 页面缓存
